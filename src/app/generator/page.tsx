...
const QR_TYPES = [
  ...
  { id: 'wifi', label: 'WiFi Network', isPremium: true },
  { id: 'vcard', label: 'vCard / Contact', isPremium: true },
  { id: 'email', label: 'Email', isPremium: true },
  { id: 'sms', label: 'SMS Message', isPremium: true },
  { id: 'phone', label: 'Phone Call', isPremium: true },
  { id: 'crypto', label: 'Crypto Address', isPremium: true },
];
